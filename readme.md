...
The problem is equivalent to that of finding the Ground State for a ![p](https://latex.codecogs.com/gif.latex?p)-spin Ising model (an Ising model where spins interact not in pairs but in ![p](https://latex.codecogs.com/gif.latex?p)-uples) defined of a factor graph.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2OTU3OTMwNzYsMjcwNDM5NjM4LC00OD
