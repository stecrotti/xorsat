...
### Leaf Removal algorithm
 ...
 - **Dynamic transition**: At some density ~0.82 (for p=3), the core size jumps from zero to a value extensive with N, the number of variables 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMzExNzA2MzksLTQ4NDg2MTEzOSwxMT
